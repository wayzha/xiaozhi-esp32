...
class Esp32s3114TFTSimple : public WifiBoard {
private:
...
public:
    Esp32s3114TFTSimple() : boot_button_(BOOT_BUTTON_GPIO) {
        ESP_LOGI(TAG, "Initializing ESP32S3 1.14TFT Board (Simple Version)");
...
// 注册开发板
DECLARE_BOARD(Esp32s3114TFTSimple);